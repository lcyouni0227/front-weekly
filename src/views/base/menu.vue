    ...
    >
        <template slot="queryArea">
            <el-form-item label="菜单编号">
                <el-input v-tooltip="'菜单编号'" :size="$style.size()" v-model="query.mid" placeholder="菜单编号"></el-input>
            </el-form-item>
            <el-form-item label="模块名称">
                <el-input :size="$style.size()" v-query="'like'" v-model="query.name" placeholder="菜单名称"></el-input>
            </el-form-item>
        ...
        <el-table-column prop="sysid" label="所属系统" width="200">
            <template slot-scope="scope">
                ...
                <el-select v-else :size="$style.size()" v-model="scope.row.sysid" placeholder="请选择">
                    <el-option
                ...
                <!--<el-input v-else :size="$style.size()" v-model="scope.row.sysid" required minlength="1" maxlength="6" placeholder="所属系统"></el-input>-->
            </template>
        </el-table-column>
